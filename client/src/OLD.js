...
var Drivers = Vue.component('drivers', {
  ...
  beforeRouteEnter: function (to, from, next) {
    axios.get('/api/drivers').then(function (response) {
  ...
  methods: {
    addDriver: function (pkg) {
      ...
      axios.post('/api/drivers', {name: pkg.name}).then(function () {
    ...
    search: function (query) {
      ...
      this.searchItems = axios.get('/api/drivers/' + query).then(function (response) {
    ...
    getDrivers() {
      return axios.get('/api/drivers').then(function (response) {
        return response.data;
      });
    },
